...
namespace OpenRouter
{
    public partial class SubpackageApiKeysClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_UpdateKeysSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_UpdateKeysSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_UpdateKeysSecurityRequirement0,
            };
        ...
        partial void ProcessUpdateKeysResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await UpdateKeysAsResponseAsync(
                hash: hash,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateKeysSecurityRequirements,
                operationName: "UpdateKeysAsync");
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateKeysResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.ApiKeysUpdateKeysResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.ApiKeysUpdateKeysResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.ApiKeysUpdateKeysResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
