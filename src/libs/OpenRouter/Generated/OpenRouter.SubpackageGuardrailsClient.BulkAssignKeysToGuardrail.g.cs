...
namespace OpenRouter
{
    public partial class SubpackageGuardrailsClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_BulkAssignKeysToGuardrailSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_BulkAssignKeysToGuardrailSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_BulkAssignKeysToGuardrailSecurityRequirement0,
            };
        partial void PrepareBulkAssignKeysToGuardrailArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::OpenRouter.BulkAssignKeysRequest request);
        partial void PrepareBulkAssignKeysToGuardrailRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            global::OpenRouter.BulkAssignKeysRequest request);
        partial void ProcessBulkAssignKeysToGuardrailResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBulkAssignKeysToGuardrailResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.BulkAssignKeysResponse> BulkAssignKeysToGuardrailAsync(
            global::System.Guid id,
        ...
        {
            var __response = await BulkAssignKeysToGuardrailAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.BulkAssignKeysResponse>> BulkAssignKeysToGuardrailAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBulkAssignKeysToGuardrailArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BulkAssignKeysToGuardrailSecurityRequirements,
                operationName: "BulkAssignKeysToGuardrailAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBulkAssignKeysToGuardrailRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BulkAssignKeysToGuardrailAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBulkAssignKeysToGuardrailResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBulkAssignKeysToGuardrailResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.BulkAssignKeysResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.BulkAssignKeysResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.BulkAssignKeysResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.BulkAssignKeysResponse> BulkAssignKeysToGuardrailAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::OpenRouter.BulkAssignKeysRequest
            {
                KeyHashes = keyHashes,
            };

            return await BulkAssignKeysToGuardrailAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
