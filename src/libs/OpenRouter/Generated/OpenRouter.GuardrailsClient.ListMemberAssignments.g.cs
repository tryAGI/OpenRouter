...
namespace OpenRouter
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_ListMemberAssignmentsSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_ListMemberAssignmentsSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_ListMemberAssignmentsSecurityRequirement0,
            };
        ...
        partial void ProcessListMemberAssignmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ListMemberAssignmentsAsResponseAsync(
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.ListMemberAssignmentsResponse>> ListMemberAssignmentsAsResponseAsync(
            int? offset = default,
            int? limit = default,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListMemberAssignmentsArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListMemberAssignmentsSecurityRequirements,
                operationName: "ListMemberAssignmentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListMemberAssignmentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListMemberAssignmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListMemberAssignmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
