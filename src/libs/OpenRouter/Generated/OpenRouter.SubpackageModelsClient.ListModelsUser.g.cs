...
namespace OpenRouter
{
    public partial class SubpackageModelsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // Not Found - No eligible endpoints found
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::OpenRouter.ModelsListResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::OpenRouter.ModelsListResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
