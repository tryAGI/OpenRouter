...
namespace OpenRouter
{
    ...
    public static class OutputItemsVariant16TypeExtensions
    {
        ...
        public static string ToValueString(this OutputItemsVariant16Type value)
        {
            return value switch
            {
                OutputItemsVariant16Type.Openrouter_imageGeneration => "openrouter:image_generation",
        ...
        public static OutputItemsVariant16Type? ToEnum(string value)
        {
            return value switch
            {
                "openrouter:image_generation" => OutputItemsVariant16Type.Openrouter_imageGeneration,
                _ => null,
            };
        }
    }
