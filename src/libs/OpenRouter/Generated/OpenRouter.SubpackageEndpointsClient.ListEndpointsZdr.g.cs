...
namespace OpenRouter
{
    public partial class SubpackageEndpointsClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_ListEndpointsZdrSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_ListEndpointsZdrSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_ListEndpointsZdrSecurityRequirement0,
            };
        partial void PrepareListEndpointsZdrArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareListEndpointsZdrRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessListEndpointsZdrResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListEndpointsZdrResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.EndpointsListEndpointsZdrResponse200> ListEndpointsZdrAsync(
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListEndpointsZdrAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.EndpointsListEndpointsZdrResponse200>> ListEndpointsZdrAsResponseAsync(
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListEndpointsZdrArguments(
                httpClient: HttpClient);


            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ListEndpointsZdrSecurityRequirements,
                operationName: "ListEndpointsZdrAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListEndpointsZdrRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListEndpointsZdrResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListEndpointsZdrResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.EndpointsListEndpointsZdrResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.EndpointsListEndpointsZdrResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.EndpointsListEndpointsZdrResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
