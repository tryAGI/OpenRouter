...
{
    /// <inheritdoc />
    public class OpenResponsesResultToolsItemsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.OpenResponsesResultToolsItems>
    {
        /// <inheritdoc />
        public override global::OpenRouter.OpenResponsesResultToolsItems Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::OpenRouter.OpenResponsesResultToolsItems0? openResponsesResultToolsItems0 = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OpenResponsesResultToolsItems0), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::OpenRouter.OpenResponsesResultToolsItems0> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::OpenRouter.OpenResponsesResultToolsItems0).Name}");
                        openResponsesResultToolsItems0 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (openResponsesResultToolsItems0 == null && previewWebSearchServerTool == null && preview20250311WebSearchServerTool == null && legacyWebSearchServerTool == null && webSearchServerTool == null && fileSearchServerTool == null && computerUseServerTool == null && codeInterpreterServerTool == null && mcpServerTool == null && imageGenerationServerTool == null && codexLocalShellTool == null && shellServerTool == null && applyPatchServerTool == null && customTool == null && namespaceTool == null)
            {
                try
                {
            ...
            var __value = new global::OpenRouter.OpenResponsesResultToolsItems(
        ...
        public override void Write(
            ...
            global::OpenRouter.OpenResponsesResultToolsItems value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsOpenResponsesResultToolsItems0)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OpenResponsesResultToolsItems0), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::OpenRouter.OpenResponsesResultToolsItems0?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::OpenRouter.OpenResponsesResultToolsItems0).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.OpenResponsesResultToolsItems0!, typeInfo);
            }
