...
{
    /// <inheritdoc />
    public class EmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSortJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.EmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSort>
    {
        /// <inheritdoc />
        public override global::OpenRouter.EmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSort Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            object? embeddingsPostRequestBodyContentApplicationJsonSchemaProviderSortVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        embeddingsPostRequestBodyContentApplicationJsonSchemaProviderSortVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (providerSort == null && providerSortConfig == null && embeddingsPostRequestBodyContentApplicationJsonSchemaProviderSortVariant3 == null)
            {
                try
                {
            ...
            var __value = new global::OpenRouter.EmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSort(
                providerSort,
        ...
        public override void Write(
            ...
            global::OpenRouter.EmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSort value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsEmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSortVariant3)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EmbeddingsPostRequestBodyContentApplicationJsonSchemaProviderSortVariant3!, typeInfo);
            }
        }
    }
}