            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::OpenRouter.AnalyticsGetUserActivityResponse200.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::OpenRouter.AnalyticsGetUserActivityResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
