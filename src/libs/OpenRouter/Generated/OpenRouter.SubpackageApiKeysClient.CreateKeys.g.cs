            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::OpenRouter.ApiKeysCreateKeysResponse201.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::OpenRouter.ApiKeysCreateKeysResponse201.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
