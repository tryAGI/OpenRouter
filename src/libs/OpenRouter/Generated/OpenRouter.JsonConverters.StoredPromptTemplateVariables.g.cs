...
{
    /// <inheritdoc />
    public class StoredPromptTemplateVariablesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.StoredPromptTemplateVariables>
    {
        /// <inheritdoc />
        public override global::OpenRouter.StoredPromptTemplateVariables Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("image_url")) __score2++;
            if (__jsonProps.Contains("type")) __score2++;
            var __score3 = 0;
            if (__jsonProps.Contains("file_data")) __score3++;
            if (__jsonProps.Contains("file_id")) __score3++;
            if (__jsonProps.Contains("file_url")) __score3++;
            if (__jsonProps.Contains("filename")) __score3++;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        storedPromptTemplateVariablesVariant1 = global::System.Text.Json.JsonSerializer.Deserialize<string>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        inputImage = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.InputImage>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
        ...
        public override void Write(
            ...
            global::OpenRouter.StoredPromptTemplateVariables value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.StoredPromptTemplateVariablesVariant1, typeof(string), options);
            }
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.InputImage, typeof(global::OpenRouter.InputImage), options);
            }
