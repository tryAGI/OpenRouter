...
{
    /// <inheritdoc />
    public class OutputFunctionCallItemStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.OutputFunctionCallItemStatus>
    {
        /// <inheritdoc />
        public override global::OpenRouter.OutputFunctionCallItemStatus Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OutputFunctionCallItemStatus0), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OutputFunctionCallItemStatus1), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score2 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OutputFunctionCallItemStatus2), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::OpenRouter.OutputFunctionCallItemStatus0? outputFunctionCallItemStatus0 = default;
            global::OpenRouter.OutputFunctionCallItemStatus1? outputFunctionCallItemStatus1 = default;
            global::OpenRouter.OutputFunctionCallItemStatus2? outputFunctionCallItemStatus2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        outputFunctionCallItemStatus0 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        outputFunctionCallItemStatus1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        outputFunctionCallItemStatus2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (outputFunctionCallItemStatus0 == null && outputFunctionCallItemStatus1 == null && outputFunctionCallItemStatus2 == null)
            {
                try
                {
            ...
            var __value = new global::OpenRouter.OutputFunctionCallItemStatus(
        ...
        public override void Write(
            ...
            global::OpenRouter.OutputFunctionCallItemStatus value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsOutputFunctionCallItemStatus0)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OutputFunctionCallItemStatus0), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::OpenRouter.OutputFunctionCallItemStatus0> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::OpenRouter.OutputFunctionCallItemStatus0).Name}");
