...
namespace OpenRouter
{
    public partial class SubpackageGuardrailsClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_BulkUnassignKeysFromGuardrailSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_BulkUnassignKeysFromGuardrailSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_BulkUnassignKeysFromGuardrailSecurityRequirement0,
            };
        partial void PrepareBulkUnassignKeysFromGuardrailArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::OpenRouter.BulkUnassignKeysRequest request);
        partial void PrepareBulkUnassignKeysFromGuardrailRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            global::OpenRouter.BulkUnassignKeysRequest request);
        partial void ProcessBulkUnassignKeysFromGuardrailResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBulkUnassignKeysFromGuardrailResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.BulkUnassignKeysResponse> BulkUnassignKeysFromGuardrailAsync(
            global::System.Guid id,
        ...
        {
            var __response = await BulkUnassignKeysFromGuardrailAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.BulkUnassignKeysResponse>> BulkUnassignKeysFromGuardrailAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBulkUnassignKeysFromGuardrailArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BulkUnassignKeysFromGuardrailSecurityRequirements,
                operationName: "BulkUnassignKeysFromGuardrailAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBulkUnassignKeysFromGuardrailRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BulkUnassignKeysFromGuardrailAsync",
                                pathTemplate: "$\"/guardrails/{id}/assignments/keys/remove\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBulkUnassignKeysFromGuardrailResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBulkUnassignKeysFromGuardrailResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.BulkUnassignKeysResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.BulkUnassignKeysResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.BulkUnassignKeysResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.BulkUnassignKeysResponse> BulkUnassignKeysFromGuardrailAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::OpenRouter.BulkUnassignKeysRequest
            {
                KeyHashes = keyHashes,
            };

            return await BulkUnassignKeysFromGuardrailAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
