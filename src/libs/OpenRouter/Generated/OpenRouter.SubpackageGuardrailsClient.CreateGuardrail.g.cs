            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::OpenRouter.GuardrailsCreateGuardrailResponse201.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::OpenRouter.GuardrailsCreateGuardrailResponse201.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
