...
namespace OpenRouter.JsonConverters
{
    ...
    public class ChatRequestReasoningSummaryJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.ChatRequestReasoningSummary>
    {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        chatReasoningSummaryVerbosityEnum = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.ChatReasoningSummaryVerbosityEnum>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ChatReasoningSummaryVerbosityEnum, typeof(global::OpenRouter.ChatReasoningSummaryVerbosityEnum), options);
            }
