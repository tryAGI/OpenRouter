...
{
    /// <inheritdoc />
    public class PreferredMaxLatencyJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.PreferredMaxLatency>
    {
        /// <inheritdoc />
        public override global::OpenRouter.PreferredMaxLatency Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        percentileLatencyCutoffs = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.PercentileLatencyCutoffs>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
        ...
        public override void Write(
            ...
            global::OpenRouter.PreferredMaxLatency value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PercentileLatencyCutoffs, typeof(global::OpenRouter.PercentileLatencyCutoffs), options);
            }
