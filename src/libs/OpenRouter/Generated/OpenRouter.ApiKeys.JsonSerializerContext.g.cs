...
namespace OpenRouter
{
    ...
    public sealed partial class ApiKeysSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ApiKeysSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ApiKeysSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
