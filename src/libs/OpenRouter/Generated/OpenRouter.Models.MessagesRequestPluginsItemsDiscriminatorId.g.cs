...
namespace OpenRouter
{
    ...
    public static class MessagesRequestPluginsItemsDiscriminatorIdExtensions
    {
        ...
        public static string ToValueString(this MessagesRequestPluginsItemsDiscriminatorId value)
        {
            return value switch
            {
                MessagesRequestPluginsItemsDiscriminatorId.AutoBetaRouter => "auto-beta-router",
                ...
                MessagesRequestPluginsItemsDiscriminatorId.WebFetch => "web-fetch",
        ...
        public static MessagesRequestPluginsItemsDiscriminatorId? ToEnum(string value)
        {
            return value switch
            {
                "auto-beta-router" => MessagesRequestPluginsItemsDiscriminatorId.AutoBetaRouter,
                ...
                "web-fetch" => MessagesRequestPluginsItemsDiscriminatorId.WebFetch,
                _ => null,
            };
        }
    }
