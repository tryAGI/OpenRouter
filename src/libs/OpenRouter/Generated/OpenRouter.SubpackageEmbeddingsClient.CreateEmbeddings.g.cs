...
namespace OpenRouter
{
    public partial class SubpackageEmbeddingsClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_CreateEmbeddingsSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_CreateEmbeddingsSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.EmbeddingsCreateEmbeddingsResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.EmbeddingsCreateEmbeddingsResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.EmbeddingsCreateEmbeddingsResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
