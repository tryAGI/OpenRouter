...
namespace OpenRouter
{
    public partial class SubpackageAnthropicMessagesClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_CreateMessagesSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_CreateMessagesSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_CreateMessagesSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateMessagesSecurityRequirements,
                operationName: "CreateMessagesAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateMessagesAsync",
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::OpenRouter.ApiException<global::OpenRouter.MessagesErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.MessagesResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.MessagesResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.MessagesResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
