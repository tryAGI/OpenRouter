...
namespace OpenRouter.JsonConverters
{
    ...
    public class InputsOneOf1ItemsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.InputsOneOf1Items>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("outcome")) __score31++;
            if (__jsonProps.Contains("status")) __score31++;
            if (__jsonProps.Contains("task_description")) __score31++;
            if (__jsonProps.Contains("task_name")) __score31++;
            if (__jsonProps.Contains("type")) __score31++;
            var __score32 = 0;
            if (__jsonProps.Contains("action")) __score32++;
            if (__jsonProps.Contains("action.command")) __score32++;
            if (__jsonProps.Contains("action.env")) __score32++;
            if (__jsonProps.Contains("action.timeout_ms")) __score32++;
            if (__jsonProps.Contains("action.type")) __score32++;
            if (__jsonProps.Contains("action.user")) __score32++;
            if (__jsonProps.Contains("action.working_directory")) __score32++;
            ...
            if (__jsonProps.Contains("action.commands")) __score34++;
            if (__jsonProps.Contains("action.max_output_length")) __score34++;
            if (__jsonProps.Contains("action.timeout_ms")) __score34++;
            if (__jsonProps.Contains("call_id")) __score34++;
            if (__jsonProps.Contains("environment")) __score34++;
            ...
            if (__jsonProps.Contains("input")) __score40++;
            if (__jsonProps.Contains("name")) __score40++;
            if (__jsonProps.Contains("namespace")) __score40++;
            ...
            var __score42 = 0;
            if (__jsonProps.Contains("encrypted_content")) __score42++;
