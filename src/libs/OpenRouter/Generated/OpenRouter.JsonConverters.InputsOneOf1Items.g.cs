...
namespace OpenRouter.JsonConverters
{
    ...
    public class InputsOneOf1ItemsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.InputsOneOf1Items>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score30 = 0;
            if (__jsonProps.Contains("analysis")) __score30++;
            if (__jsonProps.Contains("analysis.blind_spots")) __score30++;
            if (__jsonProps.Contains("analysis.consensus")) __score30++;
            if (__jsonProps.Contains("analysis.contradictions")) __score30++;
            if (__jsonProps.Contains("analysis.partial_coverage")) __score30++;
            if (__jsonProps.Contains("analysis.unique_insights")) __score30++;
            if (__jsonProps.Contains("error")) __score30++;
            if (__jsonProps.Contains("failed_models")) __score30++;
            ...
            if (__jsonProps.Contains("error")) __score31++;
            if (__jsonProps.Contains("id")) __score31++;
            if (__jsonProps.Contains("instance_name")) __score31++;
            if (__jsonProps.Contains("model")) __score31++;
            if (__jsonProps.Contains("prompt")) __score31++;
            if (__jsonProps.Contains("status")) __score31++;
            var __score32 = 0;
            if (__jsonProps.Contains("error")) __score32++;
            if (__jsonProps.Contains("id")) __score32++;
            if (__jsonProps.Contains("model")) __score32++;
            if (__jsonProps.Contains("outcome")) __score32++;
            if (__jsonProps.Contains("status")) __score32++;
            if (__jsonProps.Contains("task_description")) __score32++;
            if (__jsonProps.Contains("task_name")) __score32++;
            if (__jsonProps.Contains("type")) __score32++;
            var __score33 = 0;
            if (__jsonProps.Contains("error")) __score33++;
            if (__jsonProps.Contains("file_id")) __score33++;
            if (__jsonProps.Contains("filename")) __score33++;
            if (__jsonProps.Contains("id")) __score33++;
            if (__jsonProps.Contains("operation")) __score33++;
            if (__jsonProps.Contains("result")) __score33++;
            if (__jsonProps.Contains("status")) __score33++;
            var __score34 = 0;
            if (__jsonProps.Contains("action")) __score34++;
            if (__jsonProps.Contains("action.command")) __score34++;
            if (__jsonProps.Contains("action.env")) __score34++;
            if (__jsonProps.Contains("action.timeout_ms")) __score34++;
            if (__jsonProps.Contains("action.type")) __score34++;
            if (__jsonProps.Contains("action.user")) __score34++;
            if (__jsonProps.Contains("action.working_directory")) __score34++;
            ...
            if (__jsonProps.Contains("output")) __score35++;
            if (__jsonProps.Contains("status")) __score35++;
            if (__jsonProps.Contains("type")) __score35++;
            var __score36 = 0;
            if (__jsonProps.Contains("action")) __score36++;
            if (__jsonProps.Contains("action.commands")) __score36++;
            if (__jsonProps.Contains("action.max_output_length")) __score36++;
            if (__jsonProps.Contains("action.timeout_ms")) __score36++;
            if (__jsonProps.Contains("call_id")) __score36++;
            if (__jsonProps.Contains("environment")) __score36++;
            if (__jsonProps.Contains("id")) __score36++;
            if (__jsonProps.Contains("status")) __score36++;
            if (__jsonProps.Contains("type")) __score36++;
            var __score37 = 0;
            if (__jsonProps.Contains("call_id")) __score37++;
            if (__jsonProps.Contains("id")) __score37++;
            if (__jsonProps.Contains("max_output_length")) __score37++;
            if (__jsonProps.Contains("output")) __score37++;
            if (__jsonProps.Contains("status")) __score37++;
            ...
            if (__jsonProps.Contains("tools")) __score38++;
            if (__jsonProps.Contains("type")) __score38++;
            var __score39 = 0;
            if (__jsonProps.Contains("arguments")) __score39++;
            if (__jsonProps.Contains("id")) __score39++;
            if (__jsonProps.Contains("name")) __score39++;
            if (__jsonProps.Contains("server_label")) __score39++;
            if (__jsonProps.Contains("type")) __score39++;
            var __score40 = 0;
            if (__jsonProps.Contains("approval_request_id")) __score40++;
            if (__jsonProps.Contains("approve")) __score40++;
            if (__jsonProps.Contains("id")) __score40++;
            if (__jsonProps.Contains("reason")) __score40++;
            if (__jsonProps.Contains("type")) __score40++;
            var __score41 = 0;
            if (__jsonProps.Contains("arguments")) __score41++;
            if (__jsonProps.Contains("error")) __score41++;
            if (__jsonProps.Contains("id")) __score41++;
            if (__jsonProps.Contains("name")) __score41++;
            if (__jsonProps.Contains("output")) __score41++;
            if (__jsonProps.Contains("server_label")) __score41++;
            if (__jsonProps.Contains("type")) __score41++;
            var __score42 = 0;
            if (__jsonProps.Contains("call_id")) __score42++;
            if (__jsonProps.Contains("id")) __score42++;
            if (__jsonProps.Contains("input")) __score42++;
            if (__jsonProps.Contains("name")) __score42++;
            if (__jsonProps.Contains("namespace")) __score42++;
            if (__jsonProps.Contains("type")) __score42++;
            var __score43 = 0;
            if (__jsonProps.Contains("call_id")) __score43++;
            if (__jsonProps.Contains("id")) __score43++;
            if (__jsonProps.Contains("output")) __score43++;
            if (__jsonProps.Contains("type")) __score43++;
            var __score44 = 0;
            if (__jsonProps.Contains("encrypted_content")) __score44++;
            if (__jsonProps.Contains("id")) __score44++;
            if (__jsonProps.Contains("type")) __score44++;
            var __score45 = 0;
            if (__jsonProps.Contains("encrypted_content")) __score45++;
            if (__jsonProps.Contains("id")) __score45++;
            if (__jsonProps.Contains("type")) __score45++;
            var __score46 = 0;
            if (__jsonProps.Contains("id")) __score46++;
            if (__jsonProps.Contains("type")) __score46++;
            var __score47 = 0;
            if (__jsonProps.Contains("id")) __score47++;
            if (__jsonProps.Contains("role")) __score47++;
            if (__jsonProps.Contains("tools")) __score47++;
            if (__jsonProps.Contains("type")) __score47++;
            var __score48 = 0;
            if (__jsonProps.Contains("agent")) __score48++;
            if (__jsonProps.Contains("author")) __score48++;
            if (__jsonProps.Contains("content")) __score48++;
            if (__jsonProps.Contains("id")) __score48++;
            if (__jsonProps.Contains("recipient")) __score48++;
            ...
            global::OpenRouter.OutputFusionServerToolItem? outputFusionServerToolItem = default;
            global::OpenRouter.OutputAdvisorServerToolItem? outputAdvisorServerToolItem = default;
            global::OpenRouter.OutputSubagentServerToolItem? outputSubagentServerToolItem = default;
            global::OpenRouter.OutputFilesServerToolItem? outputFilesServerToolItem = default;
            ...
            global::OpenRouter.ContextCompactionItem? contextCompactionItem = default;
            global::OpenRouter.ItemReferenceItem? itemReferenceItem = default;
            global::OpenRouter.AdditionalToolsItem? additionalToolsItem = default;
            global::OpenRouter.AgentMessageItem? agentMessageItem = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 30)
                {
                    try
                    {
                        ...
                        outputFusionServerToolItem = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 32)
                {
                    try
                    {
                        ...
                        outputSubagentServerToolItem = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 33)
                {
                    try
                    {
                        ...
                        outputFilesServerToolItem = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 45)
                {
                    try
                    {
                        ...
                        contextCompactionItem = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 47)
                {
                    try
                    {
                        ...
                        additionalToolsItem = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 48)
                {
                    try
                    {
                        ...
                        agentMessageItem = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
