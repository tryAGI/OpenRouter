...
namespace OpenRouter.JsonConverters
{
    ...
    public class InputsOneOf1ItemsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.InputsOneOf1Items>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("action.command")) __score33++;
            if (__jsonProps.Contains("action.env")) __score33++;
            if (__jsonProps.Contains("action.timeout_ms")) __score33++;
            if (__jsonProps.Contains("action.type")) __score33++;
            if (__jsonProps.Contains("action.user")) __score33++;
            if (__jsonProps.Contains("action.working_directory")) __score33++;
            ...
            var __score35 = 0;
            if (__jsonProps.Contains("action")) __score35++;
            if (__jsonProps.Contains("action.commands")) __score35++;
            if (__jsonProps.Contains("action.max_output_length")) __score35++;
            if (__jsonProps.Contains("action.timeout_ms")) __score35++;
            if (__jsonProps.Contains("call_id")) __score35++;
            if (__jsonProps.Contains("environment")) __score35++;
            ...
            if (__jsonProps.Contains("max_output_length")) __score36++;
            if (__jsonProps.Contains("output")) __score36++;
            if (__jsonProps.Contains("status")) __score36++;
            if (__jsonProps.Contains("type")) __score36++;
            var __score37 = 0;
            if (__jsonProps.Contains("error")) __score37++;
            if (__jsonProps.Contains("id")) __score37++;
            if (__jsonProps.Contains("server_label")) __score37++;
            if (__jsonProps.Contains("tools")) __score37++;
            ...
            var __score39 = 0;
            if (__jsonProps.Contains("approval_request_id")) __score39++;
            if (__jsonProps.Contains("approve")) __score39++;
            if (__jsonProps.Contains("id")) __score39++;
            if (__jsonProps.Contains("reason")) __score39++;
            if (__jsonProps.Contains("type")) __score39++;
            var __score40 = 0;
            if (__jsonProps.Contains("arguments")) __score40++;
            if (__jsonProps.Contains("error")) __score40++;
            if (__jsonProps.Contains("id")) __score40++;
            if (__jsonProps.Contains("name")) __score40++;
            if (__jsonProps.Contains("output")) __score40++;
            if (__jsonProps.Contains("server_label")) __score40++;
            if (__jsonProps.Contains("type")) __score40++;
            var __score41 = 0;
            if (__jsonProps.Contains("call_id")) __score41++;
            if (__jsonProps.Contains("id")) __score41++;
            if (__jsonProps.Contains("input")) __score41++;
            if (__jsonProps.Contains("name")) __score41++;
            if (__jsonProps.Contains("namespace")) __score41++;
            if (__jsonProps.Contains("type")) __score41++;
            var __score42 = 0;
            if (__jsonProps.Contains("call_id")) __score42++;
            if (__jsonProps.Contains("id")) __score42++;
            if (__jsonProps.Contains("output")) __score42++;
            if (__jsonProps.Contains("type")) __score42++;
            var __score43 = 0;
            if (__jsonProps.Contains("encrypted_content")) __score43++;
