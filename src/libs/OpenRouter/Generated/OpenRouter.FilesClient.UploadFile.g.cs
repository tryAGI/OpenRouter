...
namespace OpenRouter
{
    public partial class FilesClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_UploadFileSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_UploadFileSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (workspaceId != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(workspaceId.ToString() ?? string.Empty),
                                    name: "\"workspace_id\"");
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::OpenRouter.FileMetadata.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::OpenRouter.FileMetadata.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
