...
{
    /// <inheritdoc />
    public class McpServerToolRequireApprovalJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.McpServerToolRequireApproval>
    {
        /// <inheritdoc />
        public override global::OpenRouter.McpServerToolRequireApproval Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        mcpServerToolRequireApproval0 = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.McpServerToolRequireApproval0>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        mcpServerToolRequireApproval1 = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.McpServerToolRequireApproval1>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        mcpServerToolRequireApproval2 = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.McpServerToolRequireApproval2>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
        ...
        public override void Write(
            ...
            global::OpenRouter.McpServerToolRequireApproval value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.McpServerToolRequireApproval0, typeof(global::OpenRouter.McpServerToolRequireApproval0), options);
            }
            else if (value.IsMcpServerToolRequireApproval1)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.McpServerToolRequireApproval1, typeof(global::OpenRouter.McpServerToolRequireApproval1), options);
            }
            else if (value.IsMcpServerToolRequireApproval2)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.McpServerToolRequireApproval2, typeof(global::OpenRouter.McpServerToolRequireApproval2), options);
            }
