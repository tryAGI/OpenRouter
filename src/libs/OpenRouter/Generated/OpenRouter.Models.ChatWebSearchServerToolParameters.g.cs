...
namespace OpenRouter
{
    ...
    /// 
    /// </summary>
    public sealed partial class ChatWebSearchServerToolParameters
    {
        /// <summary>
        /// Which search engine to use. "auto" (default) uses native if the provider supports it, otherwise Exa. "native" forces the provider's built-in search. "exa" forces the Exa search API. "firecrawl" uses Firecrawl (requires BYOK). "parallel" uses the Parallel search API.
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("engine")]
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::OpenRouter.JsonConverters.ChatWebSearchServerToolParametersEngineJsonConverter))]
        public global::OpenRouter.ChatWebSearchServerToolParametersEngine? Engine { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::OpenRouter.JsonConverters.ChatWebSearchServerToolParametersSearchContextSizeJsonConverter))]
        public global::OpenRouter.ChatWebSearchServerToolParametersSearchContextSize? SearchContextSize { get; set; }
        ...
        public global::OpenRouter.ChatWebSearchServerToolParametersUserLocation? UserLocation { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatWebSearchServerToolParameters" /> class.
        /// </summary>
        /// <param name="engine">
        /// Which search engine to use. "auto" (default) uses native if the provider supports it, otherwise Exa. "native" forces the provider's built-in search. "exa" forces the Exa search API. "firecrawl" uses Firecrawl (requires BYOK). "parallel" uses the Parallel search API.
        /// </param>
...
#endif
        public ChatWebSearchServerToolParameters(
            global::OpenRouter.ChatWebSearchServerToolParametersEngine? engine,
            double? maxResults,
            double? maxTotalResults,
            global::OpenRouter.ChatWebSearchServerToolParametersSearchContextSize? searchContextSize,
            global::OpenRouter.ChatWebSearchServerToolParametersUserLocation? userLocation,
