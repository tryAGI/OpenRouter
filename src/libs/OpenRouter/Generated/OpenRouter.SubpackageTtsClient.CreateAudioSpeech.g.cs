...
{
    public partial class SubpackageTtsClient
    {


        private static readonly global::OpenRouter.EndPointSecurityRequirement s_CreateAudioSpeechSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_CreateAudioSpeechSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_CreateAudioSpeechSecurityRequirement0,
            };
        ...
        partial void ProcessCreateAudioSpeechResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        {
            var __response = await CreateAudioSpeechAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> CreateAudioSpeechAsStreamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAudioSpeechArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAudioSpeechSecurityRequirements,
                operationName: "CreateAudioSpeechAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateAudioSpeechRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateAudioSpeechAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAudioSpeechResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<byte[]>> CreateAudioSpeechAsResponseAsync(
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateAudioSpeechResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateAudioSpeechAsync(
                request: __request,
                requestOptions: requestOptions,
