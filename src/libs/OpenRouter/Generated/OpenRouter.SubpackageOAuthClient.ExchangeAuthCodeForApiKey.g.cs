            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::OpenRouter.OAuthExchangeAuthCodeForAPIKeyResponse200.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::OpenRouter.OAuthExchangeAuthCodeForAPIKeyResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
