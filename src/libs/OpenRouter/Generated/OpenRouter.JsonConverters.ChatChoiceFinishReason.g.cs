...
namespace OpenRouter.JsonConverters
{
    ...
    public class ChatChoiceFinishReasonJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.ChatChoiceFinishReason>
    {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        chatFinishReasonEnum = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.ChatFinishReasonEnum>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ChatFinishReasonEnum, typeof(global::OpenRouter.ChatFinishReasonEnum), options);
            }
