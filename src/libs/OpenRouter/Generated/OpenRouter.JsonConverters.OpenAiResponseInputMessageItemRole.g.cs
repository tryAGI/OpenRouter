...
{
    /// <inheritdoc />
    public class OpenAiResponseInputMessageItemRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.OpenAiResponseInputMessageItemRole>
    {
        /// <inheritdoc />
        public override global::OpenRouter.OpenAiResponseInputMessageItemRole Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OpenAiResponseInputMessageItemRole0), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OpenAiResponseInputMessageItemRole1), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score2 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OpenAiResponseInputMessageItemRole2), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::OpenRouter.OpenAiResponseInputMessageItemRole0? openAiResponseInputMessageItemRole0 = default;
            global::OpenRouter.OpenAiResponseInputMessageItemRole1? openAiResponseInputMessageItemRole1 = default;
            global::OpenRouter.OpenAiResponseInputMessageItemRole2? openAiResponseInputMessageItemRole2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        openAiResponseInputMessageItemRole0 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        openAiResponseInputMessageItemRole1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        openAiResponseInputMessageItemRole2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (openAiResponseInputMessageItemRole0 == null && openAiResponseInputMessageItemRole1 == null && openAiResponseInputMessageItemRole2 == null)
            {
                try
                {
            ...
            var __value = new global::OpenRouter.OpenAiResponseInputMessageItemRole(
        ...
        public override void Write(
            ...
            global::OpenRouter.OpenAiResponseInputMessageItemRole value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsOpenAiResponseInputMessageItemRole0)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::OpenRouter.OpenAiResponseInputMessageItemRole0), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::OpenRouter.OpenAiResponseInputMessageItemRole0> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::OpenRouter.OpenAiResponseInputMessageItemRole0).Name}");
