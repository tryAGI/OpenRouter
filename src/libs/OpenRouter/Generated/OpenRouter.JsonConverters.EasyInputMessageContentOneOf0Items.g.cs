...
{
    /// <inheritdoc />
    public class EasyInputMessageContentOneOf0ItemsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.EasyInputMessageContentOneOf0Items>
    {
        /// <inheritdoc />
        public override global::OpenRouter.EasyInputMessageContentOneOf0Items Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::OpenRouter.EasyInputMessageContentOneOf0Items1? easyInputMessageContentOneOf0Items1 = default;
            global::OpenRouter.InputFile? inputFile = default;
            global::OpenRouter.InputAudio? inputAudio = default;
            global::OpenRouter.InputVideo? inputVideo = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        easyInputMessageContentOneOf0Items1 = global::System.Text.Json.JsonSerializer.Deserialize<global::OpenRouter.EasyInputMessageContentOneOf0Items1>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::OpenRouter.EasyInputMessageContentOneOf0Items(
                inputText,
        ...
        public override void Write(
            ...
            global::OpenRouter.EasyInputMessageContentOneOf0Items value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EasyInputMessageContentOneOf0Items1, typeof(global::OpenRouter.EasyInputMessageContentOneOf0Items1), options);
            }
