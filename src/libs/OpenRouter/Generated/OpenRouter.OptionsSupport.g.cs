...
namespace OpenRouter
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::OpenRouter.AutoSDKRetryOptions Retry { get; set; } = new global::OpenRouter.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::OpenRouter.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::OpenRouter.IAutoSDKHook>();
        ...
        public global::OpenRouter.AutoSDKClientOptions AddHook(
            global::OpenRouter.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::OpenRouter.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::OpenRouter.AutoSDKClientOptions UseAuthorizationProvider(
            global::OpenRouter.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::OpenRouter.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::OpenRouter.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::OpenRouter.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::OpenRouter.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::OpenRouter.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::OpenRouter.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::OpenRouter.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::OpenRouter.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::OpenRouter.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::OpenRouter.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::OpenRouter.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::OpenRouter.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::OpenRouter.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::OpenRouter.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::OpenRouter.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::OpenRouter.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::OpenRouter.AutoSDKClientOptions clientOptions,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::OpenRouter.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::OpenRouter.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::OpenRouter.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::OpenRouter.AutoSDKClientOptions clientOptions,
            global::System.Func<global::OpenRouter.IAutoSDKHook, global::OpenRouter.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::OpenRouter.AutoSDKHookContext context)
        {
