...
namespace OpenRouter
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_ListGuardrailKeyAssignmentsSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_ListGuardrailKeyAssignmentsSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_ListGuardrailKeyAssignmentsSecurityRequirement0,
            };
        partial void PrepareListGuardrailKeyAssignmentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref int? offset,
            ref int? limit);
        partial void PrepareListGuardrailKeyAssignmentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            int? offset,
            int? limit);
        partial void ProcessListGuardrailKeyAssignmentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListGuardrailKeyAssignmentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.ListKeyAssignmentsResponse> ListGuardrailKeyAssignmentsAsync(
            global::System.Guid id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await ListGuardrailKeyAssignmentsAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.ListKeyAssignmentsResponse>> ListGuardrailKeyAssignmentsAsResponseAsync(
            global::System.Guid id,
            int? offset = default,
            int? limit = default,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListGuardrailKeyAssignmentsArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListGuardrailKeyAssignmentsSecurityRequirements,
                operationName: "ListGuardrailKeyAssignmentsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListGuardrailKeyAssignmentsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListGuardrailKeyAssignmentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListGuardrailKeyAssignmentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.ListKeyAssignmentsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.ListKeyAssignmentsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.ListKeyAssignmentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
