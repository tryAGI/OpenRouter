...
namespace OpenRouter
{
    public partial class SubpackageOrganizationClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_ListOrganizationMembersSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_ListOrganizationMembersSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_ListOrganizationMembersSecurityRequirement0,
            };
        partial void PrepareListOrganizationMembersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? offset,
            ref int? limit);
        partial void PrepareListOrganizationMembersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? offset,
            int? limit);
        partial void ProcessListOrganizationMembersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListOrganizationMembersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.OrganizationListOrganizationMembersResponse200> ListOrganizationMembersAsync(
            int? offset = default,
            int? limit = default,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListOrganizationMembersAsResponseAsync(
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.OrganizationListOrganizationMembersResponse200>> ListOrganizationMembersAsResponseAsync(
            int? offset = default,
            int? limit = default,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListOrganizationMembersArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListOrganizationMembersSecurityRequirements,
                operationName: "ListOrganizationMembersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListOrganizationMembersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListOrganizationMembersAsync",
                                pathTemplate: "\"/organization/members\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListOrganizationMembersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListOrganizationMembersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.OrganizationListOrganizationMembersResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.OrganizationListOrganizationMembersResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.OrganizationListOrganizationMembersResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
