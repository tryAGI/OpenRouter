...
{
    public partial class SubpackageWorkspacesClient
    {


        private static readonly global::OpenRouter.EndPointSecurityRequirement s_UpsertWorkspaceBudgetSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_UpsertWorkspaceBudgetSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_UpsertWorkspaceBudgetSecurityRequirement0,
            };
        partial void PrepareUpsertWorkspaceBudgetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref global::OpenRouter.WorkspaceBudgetInterval interval,
            global::OpenRouter.UpsertWorkspaceBudgetRequest request);
        partial void PrepareUpsertWorkspaceBudgetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::OpenRouter.WorkspaceBudgetInterval interval,
            global::OpenRouter.UpsertWorkspaceBudgetRequest request);
        partial void ProcessUpsertWorkspaceBudgetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpsertWorkspaceBudgetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.UpsertWorkspaceBudgetResponse> UpsertWorkspaceBudgetAsync(
            string id,
            global::OpenRouter.WorkspaceBudgetInterval interval,
        ...
        {
            var __response = await UpsertWorkspaceBudgetAsResponseAsync(
                id: id,
                interval: interval,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.UpsertWorkspaceBudgetResponse>> UpsertWorkspaceBudgetAsResponseAsync(
            string id,
            global::OpenRouter.WorkspaceBudgetInterval interval,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpsertWorkspaceBudgetArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpsertWorkspaceBudgetSecurityRequirements,
                operationName: "UpsertWorkspaceBudgetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::OpenRouter.PathBuilder(
                                path: $"/workspaces/{id}/budgets/{(global::System.Uri.EscapeDataString(interval.ToValueString()))}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpsertWorkspaceBudgetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpsertWorkspaceBudgetAsync",
                                pathTemplate: "$\"/workspaces/{id}/budgets/{(global::System.Uri.EscapeDataString(interval.ToValueString()))}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpsertWorkspaceBudgetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpsertWorkspaceBudgetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.UpsertWorkspaceBudgetResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.UpsertWorkspaceBudgetResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.UpsertWorkspaceBudgetResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.UpsertWorkspaceBudgetResponse> UpsertWorkspaceBudgetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::OpenRouter.UpsertWorkspaceBudgetRequest
            {
                LimitUsd = limitUsd,
            };

            return await UpsertWorkspaceBudgetAsync(
                id: id,
                interval: interval,
                request: __request,
                requestOptions: requestOptions,
