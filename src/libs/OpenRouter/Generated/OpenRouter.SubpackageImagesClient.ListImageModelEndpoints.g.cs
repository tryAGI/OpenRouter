...
namespace OpenRouter
{
    public partial class SubpackageImagesClient
    {
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement s_ListImageModelEndpointsSecurityRequirement0 =
        ...
        private static readonly global::OpenRouter.EndPointSecurityRequirement[] s_ListImageModelEndpointsSecurityRequirements =
            new global::OpenRouter.EndPointSecurityRequirement[]
            {                s_ListImageModelEndpointsSecurityRequirement0,
            };
        partial void PrepareListImageModelEndpointsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string author,
            ref string slug);
        partial void PrepareListImageModelEndpointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string author,
            string slug);
        partial void ProcessListImageModelEndpointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListImageModelEndpointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::OpenRouter.ImageModelEndpointsResponse> ListImageModelEndpointsAsync(
            string author,
            string slug,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListImageModelEndpointsAsResponseAsync(
                author: author,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::OpenRouter.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.ImageModelEndpointsResponse>> ListImageModelEndpointsAsResponseAsync(
            string author,
            string slug,
            global::OpenRouter.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListImageModelEndpointsArguments(
            ...
            var __authorizations = global::OpenRouter.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListImageModelEndpointsSecurityRequirements,
                operationName: "ListImageModelEndpointsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListImageModelEndpointsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::OpenRouter.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListImageModelEndpointsAsync",
                                pathTemplate: "$\"/images/models/{author}/{slug}/endpoints\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListImageModelEndpointsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::OpenRouter.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListImageModelEndpointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::OpenRouter.ImageModelEndpointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::OpenRouter.AutoSDKHttpResponse<global::OpenRouter.ImageModelEndpointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::OpenRouter.ImageModelEndpointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
