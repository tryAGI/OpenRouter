...
{
    /// <inheritdoc />
    public class EasyInputMessageContentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::OpenRouter.EasyInputMessageContent>
    {
        /// <inheritdoc />
        public override global::OpenRouter.EasyInputMessageContent Read(
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        easyInputMessageContent0 = global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::OpenRouter.EasyInputMessageContentOneOf0Items>>(__rawJson, options);
                    }
        ...
        public override void Write(
            ...
            global::OpenRouter.EasyInputMessageContent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EasyInputMessageContent0, typeof(global::System.Collections.Generic.IList<global::OpenRouter.EasyInputMessageContentOneOf0Items>), options);
            }
